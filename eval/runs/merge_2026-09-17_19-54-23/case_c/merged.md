...
## 정의
AIMS 백엔드는 2026년 6월부로 Java 21 가상 스레드(Virtual Threads, Project Loom) 기반의 경량 스레드 동시성 모델로 전면 마이그레이션 완료되었습니다. 이전에는 OS 플랫폼 스레드 1:1 매핑 기반의 Thread Pool 모델을 사용했습니다.
